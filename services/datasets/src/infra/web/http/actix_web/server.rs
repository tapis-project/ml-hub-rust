...
pub async fn run_server() -> std::io::Result<()> {
    ...
    HttpServer::new(move || {
        App::new()
            ...
            .service(presentation::http::v1::actix_web::handlers::get_dataset_by_platform::get_dataset_by_platform)
            .service(presentation::http::v1::actix_web::handlers::list_datasets_by_platform::list_datasets_by_platform)
            .service(presentation::http::v1::actix_web::handlers::openapi::openapi)
            .service(
                SwaggerUi::new("datasets-api/swagger-ui/{_:.*}")
                    .url("/datasets-api/specs/openapi.json", ApiDoc::openapi()),
            )
    })
        .bind(addrs)?
        .run()
