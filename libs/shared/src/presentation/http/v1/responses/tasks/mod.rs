...
#[derive(Debug, Clone, Serialize, ToSchema, EnumIter, Display, AsRefStr)]
pub enum Task {
...
impl From<entities::Task> for Task {
    fn from(value: entities::Task) -> Self {
        match value {
            entities::Task::AnyToAny => Task::AnyToAny,
            entities::Task::AutomaticSpeechRecognition => Task::AutomaticSpeechRecognition,
            entities::Task::AudioToAudio => Task::AudioToAudio,
            entities::Task::AudioClassification => Task::AudioClassification,
            entities::Task::AudioTextToText => Task::AudioTextToText,
            entities::Task::DepthEstimation => Task::DepthEstimation,
            entities::Task::DocumentQuestionAnswering => Task::DocumentQuestionAnswering,
            entities::Task::FeatureExtraction => Task::FeatureExtraction,
            entities::Task::FillMask => Task::FillMask,
            entities::Task::ImageFeatureExtraction => Task::ImageFeatureExtraction,
            entities::Task::ImageTextToText => Task::ImageTextToText,
            entities::Task::ImageToVideo => Task::ImageToVideo,
            entities::Task::ImageSegmentation => Task::ImageSegmentation,
            entities::Task::ImageClassification => Task::ImageClassification,
            entities::Task::ImageTo3d => Task::ImageTo3d,
            entities::Task::ImageToImage => Task::ImageToImage,
            entities::Task::ImageToText => Task::ImageToText,
            entities::Task::KeypointDetection => Task::KeypointDetection,
            entities::Task::MaskGeneration => Task::MaskGeneration,
            entities::Task::ObjectDetection => Task::ObjectDetection,
            entities::Task::QuestionAnswering => Task::QuestionAnswering,
            entities::Task::ReinforcementLearning => Task::ReinforcementLearning,
            entities::Task::SentenceSimilarity => Task::SentenceSimilarity,
            entities::Task::Summarization => Task::Summarization,
            entities::Task::TableQuestionAnswering => Task::TableQuestionAnswering,
            entities::Task::TextGeneration => Task::TextGeneration,
            entities::Task::TextRanking => Task::TextRanking,
            entities::Task::TabularClassification => Task::TabularClassification,
            entities::Task::TextTo3d => Task::TextTo3d,
            entities::Task::TextClassification => Task::TextClassification,
            entities::Task::TextToImage => Task::TextToImage,
            entities::Task::Translation => Task::Translation,
            entities::Task::TabularRegression => Task::TabularRegression,
            entities::Task::TextToSpeech => Task::TextToSpeech,
            entities::Task::TextToVideo => Task::TextToVideo,
            entities::Task::TokenClassification => Task::TokenClassification,
            entities::Task::UnconditionalImageGeneration => Task::UnconditionalImageGeneration,
            entities::Task::VideoClassification => Task::VideoClassification,
            entities::Task::VideoTextToText => Task::VideoTextToText,
            entities::Task::VideoToVideo => Task::VideoToVideo,
            entities::Task::VisualQuestionAnswering => Task::VisualQuestionAnswering,
            entities::Task::VisualDocumentRetrieval => Task::VisualDocumentRetrieval,
            entities::Task::ZeroShotClassification => Task::ZeroShotClassification,
            entities::Task::ZeroShotImageClassification => Task::ZeroShotClassification,
            entities::Task::ZeroShotObjectDetection => Task::ZeroShotObjectDetection,
        }
    }
}
