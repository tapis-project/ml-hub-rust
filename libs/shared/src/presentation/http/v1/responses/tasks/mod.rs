...
impl From<enums::Task> for Task {
    fn from(value: enums::Task) -> Self {
        match value {
            enums::Task::AnyToAny => Task::AnyToAny,
            enums::Task::AutomaticSpeechRecognition => Task::AutomaticSpeechRecognition,
            enums::Task::AudioToAudio => Task::AudioToAudio,
            enums::Task::AudioClassification => Task::AudioClassification,
            enums::Task::AudioTextToText => Task::AudioTextToText,
            enums::Task::DepthEstimation => Task::DepthEstimation,
            enums::Task::DocumentQuestionAnswering => Task::DocumentQuestionAnswering,
            enums::Task::FeatureExtraction => Task::FeatureExtraction,
            enums::Task::FillMask => Task::FillMask,
            enums::Task::ImageFeatureExtraction => Task::ImageFeatureExtraction,
            enums::Task::ImageTextToText => Task::ImageTextToText,
            enums::Task::ImageToVideo => Task::ImageToVideo,
            enums::Task::ImageSegmentation => Task::ImageSegmentation,
            enums::Task::ImageClassification => Task::ImageClassification,
            enums::Task::ImageTo3d => Task::ImageTo3d,
            enums::Task::ImageToImage => Task::ImageToImage,
            enums::Task::ImageToText => Task::ImageToText,
            enums::Task::KeypointDetection => Task::KeypointDetection,
            enums::Task::MaskGeneration => Task::MaskGeneration,
            enums::Task::ObjectDetection => Task::ObjectDetection,
            enums::Task::QuestionAnswering => Task::QuestionAnswering,
            enums::Task::ReinforcementLearning => Task::ReinforcementLearning,
            enums::Task::SentenceSimilarity => Task::SentenceSimilarity,
            enums::Task::Summarization => Task::Summarization,
            enums::Task::TableQuestionAnswering => Task::TableQuestionAnswering,
            enums::Task::TextGeneration => Task::TextGeneration,
            enums::Task::TextRanking => Task::TextRanking,
            enums::Task::TabularClassification => Task::TabularClassification,
            enums::Task::TextTo3d => Task::TextTo3d,
            enums::Task::TextClassification => Task::TextClassification,
            enums::Task::TextToImage => Task::TextToImage,
            enums::Task::Translation => Task::Translation,
            enums::Task::TabularRegression => Task::TabularRegression,
            enums::Task::TextToSpeech => Task::TextToSpeech,
            enums::Task::TextToVideo => Task::TextToVideo,
            enums::Task::TokenClassification => Task::TokenClassification,
            enums::Task::UnconditionalImageGeneration => Task::UnconditionalImageGeneration,
            enums::Task::VideoClassification => Task::VideoClassification,
            enums::Task::VideoTextToText => Task::VideoTextToText,
            enums::Task::VideoToVideo => Task::VideoToVideo,
            enums::Task::VisualQuestionAnswering => Task::VisualQuestionAnswering,
            enums::Task::VisualDocumentRetrieval => Task::VisualDocumentRetrieval,
            enums::Task::ZeroShotClassification => Task::ZeroShotClassification,
            enums::Task::ZeroShotImageClassification => Task::ZeroShotClassification,
            enums::Task::ZeroShotObjectDetection => Task::ZeroShotObjectDetection,
        }
    }
}
