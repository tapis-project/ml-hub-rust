...
impl From<ParallelismStrategy> for entities::ParallelismStrategy {
    fn from(value: ParallelismStrategy) -> Self {
        match value {
            ParallelismStrategy::ContextParallelism => {
                entities::ParallelismStrategy::ContextParallelism
            }
            ParallelismStrategy::ExpertParallelism => {
                entities::ParallelismStrategy::ExpertParallelism
            }
            ParallelismStrategy::PipelineParallelism => {
                entities::ParallelismStrategy::PipelineParallelism
            }
            ParallelismStrategy::SequenceParallelism => {
                entities::ParallelismStrategy::SequenceParallelism
            }
            ParallelismStrategy::TensorParallelism => {
