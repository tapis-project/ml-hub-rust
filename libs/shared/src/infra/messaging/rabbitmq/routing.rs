...
pub const MODEL_DEPLOYMENT_RECONCILIATION_ROUTING_KEY: &'static str =
    "model_deployment.reconcile.queue";
pub const DEAD_LETTER_ROUTING_KEY: &'static str = "dead_letter";
