use crate::{
    ...
    shared_kernel::{
        security::{
            ...
            EncryptionEnvelope, EncryptionEnvelopeMetadata,
        },
...
impl Cipher for VaultCipher {
    ...
    async fn decrypt(&self, envelope: &EncryptionEnvelope) -> Result<Vec<u8>, CipherError> {
        let cipher_text = envelope
            .base64_decoded_payload()
