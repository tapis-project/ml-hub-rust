...
impl From<entities::artifact_ingestion::ArtifactIngestion>
    for documents::artifact_ingestion::ArtifactIngestion
{
...
impl From<entities::artifact_ingestion::ArtifactIngestion>
    for documents::artifact_ingestion::UpdateArtifactIngestionStatusRequest
{
    fn from(value: entities::artifact_ingestion::ArtifactIngestion) -> Self {
        Self {
            last_modified: value.last_modified.to_bson(),
...
impl From<entities::artifact_ingestion::ArtifactIngestion>
    for documents::artifact_ingestion::UpdateArtifactIngestionRequest
{
    fn from(value: entities::artifact_ingestion::ArtifactIngestion) -> Self {
        let artifact_path = match value.artifact_path {
            Some(p) => p.to_str().map(|s| s.to_string()),
...
impl From<entities::artifact_ingestion::ArtifactIngestionStatus>
    for documents::artifact_ingestion::ArtifactIngestionStatus
{
