...
impl From<documents::ArtifactPublicationStatus> for entities::ArtifactPublicationStatus {
    fn from(value: documents::ArtifactPublicationStatus) -> Self {
        match value {
            ...
            documents::ArtifactPublicationStatus::PublishingModel => entities::ArtifactPublicationStatus::PublishingModel,
            documents::ArtifactPublicationStatus::PublishedModel => entities::ArtifactPublicationStatus::PublishedModel,
