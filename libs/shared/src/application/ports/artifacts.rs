...
pub trait ArtifactIngestionRepository: Send + Sync {
    ...
    async fn find_by_id(
        &self,
        id: Uuid,
    ) -> Result<Option<ArtifactIngestion>, ArtifactIngestionRepositoryError>;
    async fn find_by_artifact_id(
        &self,
        id: &Uuid,
    ) -> Result<Vec<ArtifactIngestion>, ArtifactIngestionRepositoryError>;
