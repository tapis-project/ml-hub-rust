...
pub struct SearchCriterion {
    ...
    pub dataset_inputs: Option<Vec<DatasetIO>>,
    pub dataset_outputs: Option<Vec<DatasetIO>>,
...
/// Each field in the DatasetMetadata will be ANDed and each individual DatasetMetadata
/// themselves will be ORed
#[derive(Debug, Clone)]
pub struct DiscoverDatasetsInput {
