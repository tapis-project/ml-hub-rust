...
impl TryFrom<(inputs::RegisterModelInput, &RequestContext)> for domain::Model {
    type Error = ApplicationError;

    fn try_from(value: (inputs::RegisterModelInput, &RequestContext)) -> Result<Self, Self::Error> {
        let canonical = value
            .0
            .canonical
