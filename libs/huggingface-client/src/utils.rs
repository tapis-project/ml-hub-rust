...
pub(crate) async fn deserialize_response_body(
    response: Response,
    ...
    response
        ...
        .and_then(|text| {
            from_str::<Value>(&text.trim()).map_err(|err| {
...
pub(crate) async fn build_client_response(
    response: Response,
) -> Result<ClientJsonResponse<Value, Value>, ClientError> {
    ...
    match status {
        ...
        400 => {
            metadata
                .insert("remote_message".into(), Value::from("Bad Request"));
            Ok(ClientJsonResponse::new(
                Some(200),
                Some(String::from("success")),
                None,
        ...
        400..499 => {
            metadata
                .insert("remote_message".into(), Value::from("Client Error"));
            Ok(ClientJsonResponse::new(
                Some(200),
                Some(String::from("success")),
                None,
        ...
        _ => {
            metadata
                .insert("remote_message".into(), Value::from("Server Error"));
            Ok(ClientJsonResponse::new(
                Some(200),
                Some(String::from("success")),
                None,
