...
Run the following from the root of the project: `./manage run hf-model-etl -a $HF_TOKEN` where `$HF_TOKEN` is a valid Huggingface Hub access token. This will run the 3 stages of the ETL pipeline.
