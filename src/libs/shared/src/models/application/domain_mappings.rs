...
use crate::models::domain::entities as domain;
...
impl TryFrom<domain::SystemRequirement> for inputs::SystemRequirement {
    type Error = Error;
...
impl TryFrom<domain::Accelerator> for inputs::Accelerator {
    type Error = Error;
...
impl TryFrom<domain::HardwareRequirements> for inputs::HardwareRequirements {
    type Error = Error;
...
impl TryFrom<domain::ModelIO> for inputs::ModelIO {
    type Error = Error;
...
impl TryFrom<inputs::ModelDiscoveryCriteriaInput> for domain::ModelDiscoveryCriteria {
    type Error = Error;
...
impl TryFrom<domain::ModelDiscoveryCriteria> for inputs::ModelDiscoveryCriteriaInput {
    type Error = Error;
