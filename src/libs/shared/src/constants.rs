...
pub const ARTIFACT_PUBLICATION_QUEUE: &'static str = "queue.artifact.ingest";
pub const ARTIFACT_PUBLICATION_EXCHANGE: &'static str = "exchange.artifact.ingest";
pub const ARTIFACT_PUBLICATION_ROUTING_KEY: &'static str = "artifact.ingest.queue";