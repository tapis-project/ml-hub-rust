...
impl TryFrom<domain::SystemRequirement> for model_metadata::SystemRequirement {
    type Error = Error;
...
impl TryFrom<domain::Accelerator> for model_metadata::Accelerator {
    type Error = Error;
...
impl TryFrom<domain::HardwareRequirements> for model_metadata::HardwareRequirements {
    type Error = Error;
...
impl TryFrom<domain::ModelIO> for model_metadata::ModelIO {
    type Error = Error;
...
impl TryFrom<domain::ModelMetadata> for model_metadata::ModelMetadata {
    type Error = Error;
